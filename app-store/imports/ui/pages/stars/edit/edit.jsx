			...
			<div id="stars-edit-page-edit-form" className="">
				...
				<form role="form" onSubmit={this.onSubmit}>
					...
					<div className="form-group  field-objecttype">
						...
						<div className="input-div">
							<input type="text" name="objecttype" defaultValue={this.props.data.star_details.objecttype} className="form-control " required="required" />
							<span id="help-text" className="help-block" />
							<span id="error-text" className="help-block" />
						</div>
					</div>
					<div className="form-group  field-object-id">
						...
						<div className="input-div">
							<input type="text" name="objectId" defaultValue={this.props.data.star_details.objectId} className="form-control " required="required" />
							<span id="help-text" className="help-block" />
							<span id="error-text" className="help-block" />
						</div>
					</div>
