...
export const DocsPageContainer = withTracker(function(props) {
	...
	let docListPagedExtraParams = {
		...
		searchFields: Session.get("DocListPagedSearchFields") || ["name", "description", "path", "status", "markdown", "doctype", "platformId", "miniAppId", "platform.name", "miniapp.name"],
...
export class DocsPageView extends Component {
	...
	componentWillMount() {
		Session.set("DocListPagedSearchFields", ["name", "description", "path", "status", "markdown", "doctype", "platformId", "miniAppId", "platform.name", "miniapp.name"]);
	...
	exportData(fileType) {
		...
		let exportFields = ["name", "description", "path", "status", "markdown", "doctype", "platform.name", "miniapp.name"];
