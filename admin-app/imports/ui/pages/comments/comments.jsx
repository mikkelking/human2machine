...
export const CommentsPageContainer = withTracker(function(props) {
	...
	let commentListPagedExtraParams = {
		...
		searchFields: Session.get("CommentListPagedSearchFields") || ["who", "userId", "when", "comment", "docId", "doc.name"],
...
export class CommentsPageView extends Component {
	...
	componentWillMount() {
		Session.set("CommentListPagedSearchFields", ["who", "userId", "when", "comment", "docId", "doc.name"]);
	...
	exportData(fileType) {
		...
		let exportFields = ["who", "userId", "when", "comment", "doc.name"];
				...
				<table id="dataview-table" className="table table-striped table-hover">
					<thead id="dataview-table-header">
						<tr id="dataview-table-header-row">
							...
							<th className="th-sortable" data-sort="doc.name" onClick={this.onSort}>
								Doc
							</th>
							<th>
								&nbsp;
