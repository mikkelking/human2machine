...
export const StarsPageContainer = withTracker(function(props) {
	...
	let starListPagedExtraParams = {
		...
		searchFields: Session.get("StarListPagedSearchFields") || ["who", "userId", "when", "docId", "doc.name"],
...
export class StarsPageView extends Component {
	...
	componentWillMount() {
		Session.set("StarListPagedSearchFields", ["who", "userId", "when", "docId", "doc.name"]);
	...
	exportData(fileType) {
		...
		let exportFields = ["who", "userId", "when", "doc.name"];
