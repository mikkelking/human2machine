	...
	render() {
		return (
			<ul id="menu-items" className="nav navbar-nav">
				...
				<li id="menu-item-simple" className={`${menuItemClass('miniapps')}`}>
					<a href={pathFor('miniapps', {})}>
						&nbsp;
						<span className="item-title">
							MiniApps
						</span>
				...
				<li id="menu-item-simple" className={`${menuItemClass('deployments')}`}>
					<a href={pathFor('deployments', {})}>
						&nbsp;
						<span className="item-title">
							Deployments
						</span>
				...
				<li id="menu-item-simple" className={`${menuItemClass('menuitems')}`}>
					<a href={pathFor('menuitems', {})}>
						&nbsp;
						<span className="item-title">
							MenuItems
						</span>
				...
				<li id="menu-item-simple" className={`${menuItemClass('menus')}`}>
					<a href={pathFor('menus', {})}>
						&nbsp;
						<span className="item-title">
							Menus
						</span>
				...
				<li id="menu-item-simple" className={`${menuItemClass('approvals')}`}>
					<a href={pathFor('approvals', {})}>
						&nbsp;
						<span className="item-title">
							Approvals
						</span>
				...
				<li id="menu-item-simple" className={`${menuItemClass('reviews')}`}>
					<a href={pathFor('reviews', {})}>
						&nbsp;
						<span className="item-title">
							Reviews
						</span>
